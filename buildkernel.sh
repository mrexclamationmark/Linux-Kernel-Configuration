...
# Change ASFLAGS -mtune= to the right value for your cpu, read "man as" for more details.
...
KBUILD_AFLAGS="-Wa,-Os -Wa,-acdn -Wa,-mtune=core2 -Wa,--strip-local-absolute -Wa,-mrelax-relocations=yes -Wa,-mamd64 -Wa,--64"
